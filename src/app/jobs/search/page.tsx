...
export default function JobSearchPage() {
  ...
  const [leadTypeFilter, setLeadTypeFilter] = useState<'all' | 'job' | 'freelance'>('job');
  ...
  return (
    <div className="mx-auto max-w-7xl p-6">
      <div className="mb-8">
        <h1 className="text-3xl font-bold tracking-tight text-gray-900">Job Search</h1>
        <p className="text-gray-500 mt-2">Discover job opportunities tailored to your profile.</p>
      </div>
          ...
          <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-sm space-y-5">
            <div>
              ...
              >
                ...
                <option value="all">Include Freelance</option>
              </select>
            </div>
